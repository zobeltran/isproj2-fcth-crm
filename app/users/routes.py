...
def check(hbooking_email):
    """ Email Search """
    flights = FlightBooking.query.filter_by(fbooking_email = HotelBookings.hbooking_email).all();
    hotels = HotelBookings.query.filter_by(hbooking_email = HotelBookings.hbooking_email).all();
