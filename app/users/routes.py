...
def check(hbooking_email):
    """ Email Search """
    flights = FlightBooking.query.filter_by(fbooking_email = hbooking_email).first_or_404()
    hotels = HotelBookings.query.filter_by(hbooking_email = hbooking_email).first_or_404()
